...
SimpleExec is a [.NET library](https://www.nuget.org/packages/SimpleExec), developed by humans, for running external commands. It wraps [`System.Diagnostics.Process`](https://apisof.net/catalog/System.Diagnostics.Process) to make things easier.
